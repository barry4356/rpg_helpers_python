...
def gen_mission(difficulty=0):
    ...
    primary_obj_roll = dice.roll_1d6() - 1
    mission['Primary Objective'] = {}
    mission['Primary Objective']['Title'] = campaign_tables.primary_objectives[primary_obj_roll]
    mission['Primary Objective']['Description'] = campaign_tables.primary_objectives_desc[primary_obj_roll]
    mission['Secondary Objective'] = {}
    secondary_obj_roll = dice.roll_1d6() - 1
    mission['Secondary Objective']['Title'] = campaign_tables.secondary_objectives[secondary_obj_roll]
    mission['Secondary Objective']['Description'] = campaign_tables.secondary_objectives_desc[secondary_obj_roll]
    # Place Search Tokens
