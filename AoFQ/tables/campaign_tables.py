...
primary_objectives_desc={
   ...
   "Last Call" : 'Place three hiding spot markers evenly spaced along the farthest table edge from heroes. Heroes may use a skill action whilst within 1" of a marker, and if they pass a Dex or Wil test, remove the marker and roll one die. On a 5+, or if it was the last marker, the heroes have found a hiding spot, and the objective is completed. Once the heroes have completed the primary objective, they must all be within 3" of the hiding spot at the end of any round in order to end the mission and collect mission rewards.',
   "Doors of Tsevadraz" : '',
   "Bog Battle" : '',
   "Trapped Among Tombs" : '',
   "Silencing Sentries" : '',
