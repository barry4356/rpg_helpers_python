...
def turn_11():
    ...
    while exit != True:
        ...
        if(val == 0):
            ...
            roll = dice.roll_1d6()
            print(chance_tables.island_table[roll])
...
def turn_14():
    ...
    while exit != True:
        ...
        if(val == 1):
            roll = dice.roll_2d6()
            print()
            print(chance_tables.race_table[roll])
        input("Press Enter to continue...")
...
def turn_31():
    ...
    while exit != True:
        ...
        if(val == 0):
            ...
            roll = dice.roll_1d6()
            print(chance_tables.settlement_table[roll])
        elif(val == 2):
            roll = dice.roll_1d6()
            print(chance_tables.settlement_table[roll])
            roll = dice.roll_1d6()
...
def turn_41_helper(roll):
    if(roll == 3):
        ...
        roll2 = dice.roll_2d6()
        print("\t" + chance_tables.geo_table[roll2])
        roll2 = dice.roll_2d6()
        print("\t" + chance_tables.geo_table[roll2])
    elif(roll == 6):
        ...
        roll2 = dice.roll_2d6()
        print("\t" + chance_tables.race_table[roll2])
    elif(roll == 10):
        ...
        roll2 = dice.roll_1d6()
        print("\t" + chance_tables.settlement_table[roll2])
    elif(roll == 12):
